...
export const roadmap = [
  {
    ...
    imageUrl: roadmap2,
    textone: "Why to Participate?",
    texttwo: "Challenge Your Skills: Put your engineering and programming expertise to the test in dynamic challenges.",
    textthree: "Build Connections: Network with industry experts, mentors, and fellow tech enthusiasts.",
    textfour: "Compete and Conquer: Participate in robot wars and other high-stakes competitions."
  },
  {
    id: "1",
    title: "Key Highlights:",
...
export const benefits = [
  ...
  },
  {
    id: "2",
    title: "Technozion",
    text: "Technozion 2025 by Walchand College of Engineering, Sangli, is a premier event featuring Hackathon and Ideathon challenges. It’s a platform for innovators to collaborate, showcase skills, and turn ideas into impactful solutions.",
    backgroundUrl: "./src/assets/benefits/card-1.svg",
    iconUrl: benefitIcon1,
    imageUrl: benefitImage2,
    route: "/eventthree",
