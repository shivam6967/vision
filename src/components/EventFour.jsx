...
import { roadmapthree } from "../constants";
import { check2, grid, loading1 } from "../assets";
import { Gradient } from "./design/Roadmap";
import Arrow from "../assets/svg/Arrow";

const Roadmap = () => (
  <Section className="overflow-hidden" id="roadmapthree">
    <div className="container md:pb-10">
      <Heading tag="Ready to get started" title="Cybermind – The Arena of Digital Warriors!" />

      <div className="relative grid gap-6 md:grid-cols-2 md:gap-4 md:pb-[7rem]">
        {roadmapthree.map((item) => {
           return (
            <div
      ...
      <div className="flex justify-center mt-12 md:mt-15 xl:mt-20">
        <Button className="bg-black rounded-xl text-white border border-purple-500 text-xl" href="https://forms.gle/jUvmhwcj7t6H5UqV9">Register Now</Button>
        <Arrow/>
