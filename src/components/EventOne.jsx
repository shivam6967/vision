...
const Roadmap = () => (
  <Section className="overflow-hidden" id="roadmap">
    <div className="container md:pb-10">
      <Heading tag="Ready to get started" title=" Where Machines Come to Life Robo Tech!" />
      ...
      <div className="flex justify-center mt-12 md:mt-15 xl:mt-20">
        <Button className="bg-black rounded-xl text-white border border-purple-500 text-xl" href="https://forms.gle/nH9hqVA3bS4Egz8U6">Register Now</Button>
        <Arrow/>
      </div>
    </div>
  </Section>
