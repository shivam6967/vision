...
import { roadmaptwo } from "../constants";
import { check2, grid, loading1 } from "../assets";
import { Gradient } from "./design/Roadmap";
import Arrow from "../assets/svg/Arrow";

const Roadmap = () => (
  <Section className="overflow-hidden" id="roadmaptwo">
    <div className="container md:pb-10">
      <Heading tag="Ready to get started" title="Technozion – Where Innovation Meets Competition!" />
      ...
      <div className="flex justify-center mt-12 md:mt-15 xl:mt-20">
        <Button className="bg-black rounded-xl text-white border border-purple-500 text-xl" href="https://forms.gle/go3xT8DK8MmYVHFG9">Register Now</Button>
        <Arrow/>
      </div>
    </div>
  </Section>
